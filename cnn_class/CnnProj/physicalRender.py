#!/usr/bin/env python
#VTKExamples\src\Testing\Data\skyboxes\skybox2
# 79bb9fea0a5138b34c1b89a46864b09bfe045619
import sys
...
#        5: ['posx', 'negx', 'posy', 'negy', 'posz', 'negz']
    ...
    for fn in fns:
        ...
        i += 1
    texture.MipmapOn()
    #texture.SetTransform(Scale(0.5,0.5,0.5))
...
def GetBoy():
    ...
    #surface = vtk.vtkParametricBohemianDome()
